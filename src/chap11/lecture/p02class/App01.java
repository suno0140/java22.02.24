...
public class App01 {
	public static void main(String[] args) throws Exception{
		//클래스 인스턴스를 얻는 3가지 방법
		Class c1 = String.class; //class 키워드를 사용하는 방법
		
		Class c2 = Class.forName("java.lang.String"); //forName 메소드사용 (풀네임입력)
		
		String s1 = "java";
		Class c3 = s1.getClass(); //getClass 인스턴스 메소드 사용(인스턴스가 있을때)
		...
		//클래스의 이름
		System.out.println(c1.getName()); //풀네임
		System.out.println(c1.getSimpleName()); //심플네임
